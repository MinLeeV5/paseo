...
export const zhCN: TranslationResources = {
  ...
  agentPanel: {
    ...
    goal: {
      ...
      archive: {
        action: "归档 Goal",
        title: "归档此 Goal？",
        message: "这只会隐藏此 Goal 的状态栏，不会停止 Goal 或归档 Agent。",
        runningTitle: "归档此 Goal？",
        runningMessage: "这只会隐藏此 Goal 的状态栏，不会停止 Goal 或归档 Agent。",
      },
    },
  },
  sessions: {
  ...
  workspace: {
    ...
    git: {
      ...
      diff: {
        ...
        groupBySubmodule: "按 submodule 分组",
        rootDirectory: "根目录",
        workspaceRoot: "工作区",
        switchToUnified: "切换到行内差异视图",
        ...
        committed: "已 commit",
        sessionChanges: "本轮会话",
        sessionChangesDescription: "选择一次用户 Prompt，查看该轮产生的变更",
        sessionChangesUnavailable: "请更新 Host 以使用 Prompt 轮次变更。",
        promptTurnSelector: "Prompt 轮次",
        noPromptTurns: "暂无 Prompt 记录",
        promptWithAttachments: "包含附件的 Prompt",
        promptTurnMetadata: "第 {{number}} 轮 · {{status}}",
        promptTurnMetadataWithChanges: "第 {{number}} 轮 · {{status}} · {{changes}}",
        promptTurnStatus: {
          running: "进行中",
          completed: "已完成",
          failed: "失败",
        ...
        promptTurnHasChanges: "有变更",
        sessionDiffMode: "会话 Diff 模式",
        wholeFileDiff: "整个文件 Diff",
        wholeFileDiffDescription: "展示这些文件当前的完整 Git Diff",
        sessionOnlyDiff: "仅本轮修改",
        sessionOnlyDiffDescription: "仅展示本轮 Agent 会话开始后的修改",
        emptySessionChanges: "本轮会话没有变更",
        emptyPromptChanges: "该 Prompt 没有产生变更",
        sessionTrackingPending: "发送一条 Prompt 后即可开始记录轮次变更。",
        sessionAgentRequired: "请先在此工作区聚焦一个 Agent 会话。",
        branchUnknown: "未知",
        base: "base",
        newFile: "新增",
        deletedFile: "已删除",
        viewInSource: "在源码中查看变更",
        ...
        nextChange: "下一个变更",
        changeProgress: "第 {{current}} / {{total}} 个变更",
        addedLine: "新增行",
        deletedLine: "删除行",
  ...
  pairing: {
    ...
    directSetup: {
      title: "直连",
      description: "让手机上的 Paseo 通过同一局域网或私有 VPN 连接到这台电脑。",
      loadFailed: "无法加载直连设置",
      ready: "直连已就绪",
      addressLabel: "地址 · {{interfaceName}}",
      noAddress: "未找到可访问的 IPv4 地址，请检查网络连接。",
      configureTitle: "启用直连",
      changePassword: "修改直连密码",
      passwordHint: "至少使用 8 个字符；daemon 配置中只保存密码 hash。",
      enableAction: "启用并重启 daemon",
      updateAction: "更新密码并重启",
      configuring: "正在配置...",
      configureFailed: "无法配置直连。",
      passwordUnavailableTitle: "设置新密码以完成配置",
      passwordUnavailableBody:
        "daemon 已配置密码，但 Paseo 无法读取。请在下方替换密码，以生成可复制的手机端凭据。",
      securityTitle: "仅在可信网络中使用",
      securityBody:
        "直连流量不会加密。请仅使用可信局域网或私有 VPN；在公共或不可信网络中请使用加密 Relay 配对。",
      tutorialTitle: "连接手机",
      tutorialStep1: "让手机和这台电脑连接到同一个 Wi-Fi 或私有 VPN。",
      tutorialStep2: "在 Paseo 移动端选择“添加连接”→“直接连接”。",
      tutorialStep3: "输入上方任一 IP、端口和密码，然后点击“连接”。",
      relayAlternative: "或通过加密 Relay 配对",
      unavailableTitle: "直连配置不可用",
      externalDaemon: "这个 daemon 不由桌面应用管理，请通过 CLI 配置监听地址和密码。",
      managementDisabled: "请先启用内置 daemon 管理，再配置直连。",
      secureStorageUnavailable: "系统安全凭据存储不可用，Paseo 无法安全保留桌面端重连所需的密码。",
    },
    device: {
  ...
  settings: {
    ...
    appearance: {
      ...
      background: {
        title: "背景",
        image: "全局背景",
        imageHint: "选择一张显示在整个 Paseo 界面上的图片",
        choose: "选择图片",
        change: "更换",
        remove: "移除",
        imageOpacity: "背景图片强度",
        imageOpacityHint: "仅作用于背景，范围 5–50%；文字和控件始终完全不透明",
        imageOpacityAccessibility: "背景图片强度百分比",
        interfaceOpacity: "界面透明度",
        interfaceOpacityHint: "作用于文字、图标、图片、卡片和控件，范围 10–100%",
        interfaceOpacityAccessibility: "界面透明度百分比",
        dialogTitle: "选择背景图片",
        loadError: "无法使用此图片。请选择另一张本地图片后重试。",
        saveError: "无法保存背景设置，请重试。",
      },
      detailLevel: {
        title: "详细程度",
      },
