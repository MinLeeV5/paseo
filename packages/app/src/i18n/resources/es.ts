...
export const es: TranslationResources = {
  ...
  agentStream: {
    ...
    newActivity: "{{count}} novedades. Ir al final",
    ...
    permission: {
      ...
      responseFailed: "No se pudo enviar la respuesta: {{error}}. Inténtalo de nuevo.",
    },
  },
  agentPanel: {
    search: {
    ...
    workflow: {
      ...
      working: "Trabajando",
      permission: "Aprobación necesaria",
      error: "Agente detenido",
      readyForReview: "Listo para revisar",
      recoveryHint: "Recarga el agente desde el menú de la pestaña e inténtalo de nuevo",
    },
    goal: {
      status: {
        active: "Activo",
      ...
      archive: {
        action: "Archivar objetivo",
        title: "¿Archivar objetivo?",
        message:
          "Esto oculta la barra de estado del objetivo sin detener el objetivo ni el agente.",
        runningTitle: "¿Archivar objetivo?",
        runningMessage:
          "Esto oculta la barra de estado del objetivo sin detener el objetivo ni el agente.",
      },
    },
  ...
  workspace: {
    ...
    git: {
      ...
      diff: {
        ...
        view: "Vista de diferencias",
        fileGrouping: "Agrupación de archivos",
        flatFileList: "Lista plana",
        groupByDirectory: "Agrupar por directorio",
        groupBySubmodule: "Agrupar por submódulo",
        rootDirectory: "Raíz",
        workspaceRoot: "Espacio de trabajo",
        switchToUnified: "Cambiar a diferencias en línea",
        switchToSplit: "Cambiar a diferencias en paralelo",
        ...
        sessionChanges: "Sesión actual",
        promptTurnSelector: "Turno del prompt",
        noPromptTurns: "Aún no hay prompts",
        promptWithAttachments: "Prompt con archivos adjuntos",
        promptTurnMetadata: "Prompt {{number}} · {{status}}",
        promptTurnMetadataWithChanges: "Prompt {{number}} · {{status}} · {{changes}}",
        promptTurnStatus: {
          running: "En curso",
        ...
        promptTurnHasChanges: "Con cambios",
        sessionChangesDescription: "Archivos modificados desde que comenzó la sesión del agente",
        sessionChangesUnavailable: "Actualiza el host para usar los cambios por turno de prompt.",
        sessionDiffMode: "Modo de diff de sesión",
        wholeFileDiff: "Diff del archivo completo",
        wholeFileDiffDescription: "Mostrar el diff Git actual completo de cada archivo",
        sessionOnlyDiff: "Diff de la sesión",
        sessionOnlyDiffDescription: "Mostrar solo las ediciones realizadas durante esta sesión",
        emptySessionChanges: "No hay cambios en esta sesión",
        emptyPromptChanges: "No hay cambios en este prompt",
        sessionTrackingPending: "El seguimiento comenzará en el próximo turno del agente.",
        sessionAgentRequired: "Selecciona un agente en este espacio de trabajo.",
        branchUnknown: "Desconocido",
        base: "base",
        newFile: "Nuevo",
        deletedFile: "Eliminado",
        viewInSource: "Ver cambios en el código fuente",
        markFileReviewed: "Marcar archivo como revisado",
        markFileUnreviewed: "Marcar archivo como no revisado",
        ...
        changeProgress: "Cambio {{current}} de {{total}}",
        addedLine: "Línea añadida",
        deletedLine: "Línea eliminada",
  ...
  panels: {
    ...
    file: {
      ...
      editor: {
        ...
        expandFullFile: "Expandir archivo completo",
  ...
  settings: {
    ...
    appearance: {
      ...
      background: {
        title: "Fondo",
        image: "Fondo global",
        imageHint: "Elige una imagen para toda la interfaz de Paseo",
        choose: "Elegir imagen",
        change: "Cambiar",
        remove: "Eliminar",
        imageOpacity: "Opacidad de la imagen",
        imageOpacityHint: "Solo el fondo, 5–50%; el texto y los controles siguen opacos",
        imageOpacityAccessibility: "Porcentaje de opacidad de la imagen de fondo",
        interfaceOpacity: "Opacidad de la interfaz",
        interfaceOpacityHint: "Texto, iconos, imágenes, tarjetas y controles; 10–100%",
        interfaceOpacityAccessibility: "Porcentaje de opacidad de la interfaz",
        dialogTitle: "Elegir imagen de fondo",
        loadError: "No se puede usar esta imagen. Elige otra imagen local e inténtalo de nuevo.",
        saveError: "No se pudo guardar la configuración del fondo. Inténtalo de nuevo.",
      },
      detailLevel: {
