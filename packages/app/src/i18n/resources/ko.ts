  ...
  workspace: {
    ...
    git: {
      ...
      diff: {
        ...
        view: "차이 보기",
        fileGrouping: "파일 그룹화",
        flatFileList: "그룹화 안 함",
        groupByDirectory: "디렉터리별 그룹화",
        groupBySubmodule: "서브모듈별 그룹화",
        switchToUnified: "인라인 diff로 전환",
        switchToSplit: "나란히 diff로 전환",
        ...
        newFile: "신규",
        deletedFile: "삭제됨",
        viewInSource: "소스에서 변경사항 보기",
        previousChange: "이전 변경사항",
        nextChange: "다음 변경사항",
        changeProgress: "변경사항 {{current}} / {{total}}",
        addedLine: "추가된 줄",
        deletedLine: "삭제된 줄",
        commits: {
          title: "커밋",
...
export const ko = mergeTranslationResources(en, koOverrides);
