...
export const fr: TranslationResources = {
  ...
  agentPanel: {
    ...
    goal: {
      ...
      archive: {
        action: "Archiver l’objectif",
        title: "Archiver l’objectif ?",
        message: "Cela masque la barre d’état de l’objectif sans arrêter l’objectif ni l’agent.",
        runningTitle: "Archiver l’objectif ?",
        runningMessage:
          "Cela masque la barre d’état de l’objectif sans arrêter l’objectif ni l’agent.",
      },
    },
  },
  sessions: {
  ...
  workspace: {
    ...
    tabs: {
      ...
      confirmations: {
        ...
        closeAllTabsTitle: "Fermer tous les onglets?",
        bulk: {
    ...
    git: {
      ...
      diff: {
        ...
        view: "Vue des différences",
        fileGrouping: "Regroupement des fichiers",
        flatFileList: "Liste plate",
        groupByDirectory: "Grouper par dossier",
        groupBySubmodule: "Grouper par sous-module",
        rootDirectory: "Racine",
        workspaceRoot: "Espace de travail",
        switchToUnified: "Passer au diff en ligne",
        ...
        committed: "Engagé",
        sessionChanges: "Session actuelle",
        promptTurnSelector: "Tour du prompt",
        noPromptTurns: "Aucun prompt pour le moment",
        promptWithAttachments: "Prompt avec pièces jointes",
        ...
        promptTurnHasChanges: "Avec modifications",
        sessionChangesDescription: "Fichiers modifiés depuis le début de la session de l’agent",
        sessionChangesUnavailable:
          "Mettez à jour l’hôte pour utiliser les modifications par tour de prompt.",
        sessionDiffMode: "Mode de diff de session",
        wholeFileDiff: "Diff du fichier entier",
        wholeFileDiffDescription: "Afficher le diff Git actuel complet de chaque fichier",
        sessionOnlyDiff: "Diff de la session",
        sessionOnlyDiffDescription:
          "Afficher uniquement les modifications faites durant la session",
        emptySessionChanges: "Aucune modification dans cette session",
        emptyPromptChanges: "Aucune modification pour ce prompt",
        sessionTrackingPending: "Le suivi commencera au prochain tour de cet agent.",
        sessionAgentRequired: "Sélectionnez un agent dans cet espace de travail.",
        branchUnknown: "Inconnu",
        base: "base",
        newFile: "Nouveau",
        deletedFile: "Supprimé",
        viewInSource: "Voir les modifications dans le code source",
        ...
        changeProgress: "Modification {{current}} sur {{total}}",
        addedLine: "Ligne ajoutée",
        deletedLine: "Ligne supprimée",
        jumpToFileChange: "Accéder à la modification du fichier à la position {{position}}",
      ...
      openInEditor: {
        ...
        targetUnavailable: "L’outil sélectionné n’est pas disponible",
      },
      pr: {
        actions: {
  ...
  panels: {
    ...
    file: {
      ...
      editor: {
        ...
        diff: "Diff",
        source: "Source",
        expandFullFile: "Afficher le fichier entier",
  ...
  settings: {
    ...
    appearance: {
      ...
      background: {
        title: "Arrière-plan",
        image: "Arrière-plan global",
        imageHint: "Choisissez une image affichée dans toute l’interface de Paseo",
        choose: "Choisir une image",
        change: "Modifier",
        remove: "Supprimer",
        imageOpacity: "Opacité de l’image",
        imageOpacityHint: "Arrière-plan uniquement, 5–50 % ; texte et contrôles restent opaques",
        imageOpacityAccessibility: "Pourcentage d’opacité de l’image d’arrière-plan",
        interfaceOpacity: "Opacité de l’interface",
        interfaceOpacityHint: "Texte, icônes, images, cartes et contrôles ; 10–100 %",
        interfaceOpacityAccessibility: "Pourcentage d’opacité de l’interface",
        dialogTitle: "Choisir une image d’arrière-plan",
        loadError: "Impossible d’utiliser cette image. Choisissez une autre image locale.",
        saveError: "Impossible d’enregistrer l’arrière-plan. Réessayez.",
      },
      detailLevel: {
