...
export const ar: TranslationResources = {
  ...
  agentPanel: {
    ...
    goal: {
      ...
      archive: {
        action: "أرشفة الهدف",
        title: "أرشفة الهدف؟",
        message: "يؤدي هذا إلى إخفاء شريط حالة الهدف دون إيقاف الهدف أو الوكيل.",
        runningTitle: "أرشفة الهدف؟",
        runningMessage: "يؤدي هذا إلى إخفاء شريط حالة الهدف دون إيقاف الهدف أو الوكيل.",
      },
    },
  },
  sessions: {
  ...
  workspace: {
    ...
    git: {
      ...
      diff: {
        ...
        view: "عرض الفرق",
        fileGrouping: "تجميع الملفات",
        flatFileList: "قائمة مسطحة",
        groupByDirectory: "تجميع حسب الدليل",
        groupBySubmodule: "تجميع حسب الوحدة الفرعية",
        rootDirectory: "الجذر",
        workspaceRoot: "مساحة العمل",
        switchToUnified: "التبديل إلى الفرق المضمّن",
        ...
        committed: "ملتزم",
        sessionChanges: "الجلسة الحالية",
        promptTurnSelector: "دورة المطالبة",
        noPromptTurns: "لا توجد مطالبات بعد",
        promptWithAttachments: "مطالبة تحتوي على مرفقات",
        promptTurnMetadata: "المطالبة {{number}} · {{status}}",
        promptTurnMetadataWithChanges: "المطالبة {{number}} · {{status}} · {{changes}}",
        promptTurnStatus: {
          running: "قيد التشغيل",
          completed: "مكتمل",
          failed: "فشل",
        ...
        promptTurnHasChanges: "توجد تغييرات",
        sessionChangesDescription: "الملفات المعدلة منذ بدء جلسة الوكيل",
        sessionChangesUnavailable: "حدّث المضيف لاستخدام تغييرات دورة المطالبة.",
        sessionDiffMode: "وضع فرق الجلسة",
        wholeFileDiff: "فرق الملف بالكامل",
        wholeFileDiffDescription: "عرض فرق Git الحالي الكامل لكل ملف",
        sessionOnlyDiff: "فرق الجلسة فقط",
        sessionOnlyDiffDescription: "عرض التعديلات التي أُجريت منذ بدء الجلسة فقط",
        emptySessionChanges: "لا توجد تغييرات في هذه الجلسة",
        emptyPromptChanges: "لا توجد تغييرات في هذه المطالبة",
        sessionTrackingPending: "سيبدأ التتبع عند تشغيل الدور التالي لهذا الوكيل.",
        sessionAgentRequired: "حدد وكيلاً في مساحة العمل هذه.",
        branchUnknown: "مجهول",
        base: "قاعدة",
        newFile: "جديد",
        deletedFile: "تم الحذف",
        viewInSource: "عرض التغييرات في المصدر",
        ...
        changeProgress: "التغيير {{current}} من {{total}}",
        addedLine: "سطر مضاف",
        deletedLine: "سطر محذوف",
  ...
  panels: {
    ...
    file: {
      ...
      editor: {
        ...
        diff: "الاختلافات",
        source: "المصدر",
        expandFullFile: "عرض الملف كاملاً",
  ...
  settings: {
    ...
    appearance: {
      ...
      background: {
        title: "الخلفية",
        image: "الخلفية العامة",
        imageHint: "اختر صورة تظهر في واجهة Paseo بالكامل",
        choose: "اختيار صورة",
        change: "تغيير",
        remove: "إزالة",
        imageOpacity: "عتامة صورة الخلفية",
        imageOpacityHint: "للخلفية فقط، من 5 إلى 50٪؛ يبقى النص وعناصر التحكم معتمة",
        imageOpacityAccessibility: "نسبة عتامة صورة الخلفية",
        interfaceOpacity: "عتامة الواجهة",
        interfaceOpacityHint: "النص والرموز والصور والبطاقات وعناصر التحكم؛ من 10 إلى 100٪",
        interfaceOpacityAccessibility: "نسبة عتامة الواجهة",
        dialogTitle: "اختيار صورة الخلفية",
        loadError: "تعذر استخدام هذه الصورة. اختر صورة محلية أخرى وحاول مجددًا.",
        saveError: "تعذر حفظ إعداد الخلفية. حاول مجددًا.",
      },
      detailLevel: {
