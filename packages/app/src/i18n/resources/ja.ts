...
export const ja: TranslationResources = {
  ...
  agentPanel: {
    ...
    goal: {
      ...
      archive: {
        action: "Goal をアーカイブ",
        title: "Goal をアーカイブしますか？",
        message: "Goal のステータスバーだけを非表示にします。Goal とエージェントは停止しません。",
        runningTitle: "Goal をアーカイブしますか？",
        runningMessage:
          "Goal のステータスバーだけを非表示にします。Goal とエージェントは停止しません。",
      },
    },
  },
  sessions: {
    ...
    git: {
      actions: {
        ...
        archiveWarning: {
          ...
          confirm: "アーカイブ",
          cancel: "キャンセル",
          message: "ワークスペースとそのエージェントをアーカイブし、ターミナルを閉じます。",
      ...
      diff: {
        ...
        split: "並列差分",
        view: "差分表示",
        fileGrouping: "ファイルのグループ化",
        flatFileList: "フラットリスト",
        groupByDirectory: "ディレクトリでグループ化",
        groupBySubmodule: "サブモジュールでグループ化",
        rootDirectory: "ルート",
        workspaceRoot: "ワークスペース",
        switchToUnified: "インライン差分に切り替え",
        switchToSplit: "並列差分に切り替え",
        ...
        uncommitted: "未コミット",
        committed: "コミット済み",
        sessionChanges: "現在のセッション",
        promptTurnSelector: "プロンプトのターン",
        noPromptTurns: "プロンプトはまだありません",
        promptWithAttachments: "添付ファイル付きプロンプト",
        promptTurnMetadata: "プロンプト {{number}} · {{status}}",
        promptTurnMetadataWithChanges: "プロンプト {{number}} · {{status}} · {{changes}}",
        promptTurnStatus: {
          running: "実行中",
          completed: "完了",
          failed: "失敗",
        ...
        promptTurnHasChanges: "変更あり",
        sessionChangesDescription: "このエージェントセッション開始後に変更されたファイル",
        sessionChangesUnavailable: "プロンプト単位の変更を使用するにはホストを更新してください。",
        sessionDiffMode: "セッション差分モード",
        wholeFileDiff: "ファイル全体の差分",
        wholeFileDiffDescription: "各セッションファイルの現在のGit差分全体を表示",
        sessionOnlyDiff: "セッション内の差分",
        sessionOnlyDiffDescription: "このセッション開始後の編集のみを表示",
        emptySessionChanges: "このセッションに変更はありません",
        emptyPromptChanges: "このプロンプトによる変更はありません",
        sessionTrackingPending: "このエージェントが次のターンを実行すると追跡が始まります。",
        sessionAgentRequired: "このワークスペースのエージェントを選択してください。",
        branchUnknown: "不明",
        base: "ベース",
        newFile: "新規",
        deletedFile: "削除済み",
        viewInSource: "ソースで変更を表示",
        ...
        previousChange: "前の変更",
        nextChange: "次の変更",
        changeProgress: "変更 {{current}} / {{total}}",
        addedLine: "追加された行",
        deletedLine: "削除された行",
  ...
  settings: {
    ...
    appearance: {
      ...
      background: {
        title: "背景",
        image: "グローバル背景",
        imageHint: "Paseo の画面全体に表示する画像を選択します",
        choose: "画像を選択",
        change: "変更",
        remove: "削除",
        imageOpacity: "背景画像の濃度",
        imageOpacityHint: "背景のみ5–50%で調整し、文字と操作部品は不透明のままです",
        imageOpacityAccessibility: "背景画像の濃度（パーセント）",
        interfaceOpacity: "インターフェースの不透明度",
        interfaceOpacityHint: "文字、アイコン、画像、カード、操作部品を10–100%で調整します",
        interfaceOpacityAccessibility: "インターフェースの不透明度（パーセント）",
        dialogTitle: "背景画像を選択",
        loadError: "この画像は使用できません。別のローカル画像を選択してください。",
        saveError: "背景設定を保存できませんでした。もう一度お試しください。",
      },
      detailLevel: {
        title: "詳細レベル",
      },
