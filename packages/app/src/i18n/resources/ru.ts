...
export const ru: TranslationResources = {
  ...
  agentPanel: {
    ...
    goal: {
      ...
      archive: {
        action: "Архивировать цель",
        title: "Архивировать цель?",
        message: "Строка состояния цели будет скрыта, но цель и агент не будут остановлены.",
        runningTitle: "Архивировать цель?",
        runningMessage: "Строка состояния цели будет скрыта, но цель и агент не будут остановлены.",
      },
    },
  },
  sessions: {
  ...
  workspace: {
    ...
    tabs: {
      ...
      confirmations: {
        ...
        closeAllTabsTitle: "Закрыть все вкладки?",
        bulk: {
    ...
    git: {
      ...
      diff: {
        ...
        view: "Вид изменений",
        fileGrouping: "Группировка файлов",
        flatFileList: "Плоский список",
        groupByDirectory: "Группировать по каталогам",
        groupBySubmodule: "Группировать по подмодулю",
        rootDirectory: "Корень",
        workspaceRoot: "Рабочая область",
        switchToUnified: "Переключить на встроенное сравнение",
        switchToSplit: "Переключить на сравнение рядом",
        ...
        sessionChanges: "Текущий сеанс",
        promptTurnSelector: "Ход промпта",
        noPromptTurns: "Промптов пока нет",
        promptWithAttachments: "Промпт с вложениями",
        promptTurnMetadata: "Промпт {{number}} · {{status}}",
        promptTurnMetadataWithChanges: "Промпт {{number}} · {{status}} · {{changes}}",
        promptTurnStatus: {
          running: "Выполняется",
          completed: "Завершён",
          failed: "Ошибка",
        ...
        promptTurnHasChanges: "Есть изменения",
        sessionChangesDescription: "Файлы, изменённые с начала сеанса агента",
        sessionChangesUnavailable: "Обновите хост, чтобы использовать изменения по промптам.",
        sessionDiffMode: "Режим разницы сеанса",
        wholeFileDiff: "Разница всего файла",
        wholeFileDiffDescription: "Показать полную текущую Git-разницу файлов сеанса",
        sessionOnlyDiff: "Разница сеанса",
        sessionOnlyDiffDescription: "Показать только правки с начала сеанса агента",
        emptySessionChanges: "В этом сеансе нет изменений",
        emptyPromptChanges: "В этом промпте нет изменений",
        sessionTrackingPending: "Отслеживание начнётся на следующем ходе агента.",
        sessionAgentRequired: "Выберите агента в этой рабочей области.",
        branchUnknown: "Неизвестный",
        base: "база",
        newFile: "Новый",
        deletedFile: "Удалено",
        viewInSource: "Показать изменения в исходнике",
        ...
        changeProgress: "Изменение {{current}} из {{total}}",
        addedLine: "Добавленная строка",
        deletedLine: "Удалённая строка",
      ...
      openInEditor: {
        ...
        targetUnavailable: "Выбранный инструмент недоступен",
      },
      pr: {
        actions: {
  ...
  pairing: {
    ...
    directSetup: {
      title: "Прямое подключение",
      description: "Подключите Paseo на телефоне через ту же локальную сеть или частную VPN.",
      loadFailed: "Не удалось загрузить настройки прямого подключения",
      ready: "Прямое подключение готово",
      addressLabel: "Адрес · {{interfaceName}}",
      noAddress: "Доступный IPv4-адрес не найден. Проверьте подключение к сети.",
      configureTitle: "Включить прямое подключение",
      changePassword: "Изменить пароль прямого подключения",
      passwordHint:
        "Используйте не менее 8 символов. Paseo хранит в конфигурации daemon только хэш.",
      enableAction: "Включить и перезапустить daemon",
      updateAction: "Обновить пароль и перезапустить",
      configuring: "Настройка...",
      configureFailed: "Не удалось настроить прямое подключение.",
      passwordUnavailableTitle: "Задайте новый пароль для завершения настройки",
      passwordUnavailableBody:
        "У daemon уже есть пароль, который Paseo не может восстановить. Замените его ниже, чтобы создать копируемые данные для телефона.",
      securityTitle: "Используйте только в доверенной сети",
      securityBody:
        "Прямые подключения не шифруются. Используйте частную LAN или VPN; в публичных и недоверенных сетях используйте зашифрованное сопряжение через Relay.",
      tutorialTitle: "Подключите телефон",
      tutorialStep1: "Подключите телефон и этот компьютер к одной сети Wi-Fi или частной VPN.",
      tutorialStep2:
        "В мобильном приложении Paseo выберите «Добавить подключение» → «Прямое подключение».",
      tutorialStep3: "Введите один из IP-адресов выше, порт и пароль, затем нажмите «Подключить».",
      relayAlternative: "Или выполните сопряжение через зашифрованный Relay",
      unavailableTitle: "Настройка прямого подключения недоступна",
      externalDaemon:
        "Этот daemon управляется вне настольного приложения. Настройте адрес прослушивания и пароль через CLI.",
      managementDisabled: "Включите управление встроенным daemon перед настройкой прямого доступа.",
      secureStorageUnavailable:
        "Безопасное хранилище учётных данных ОС недоступно, поэтому Paseo не может безопасно сохранить пароль для повторного подключения.",
    },
    device: {
  ...
  panels: {
    ...
    file: {
      ...
      editor: {
        ...
        diff: "Различия",
        source: "Исходник",
        expandFullFile: "Развернуть весь файл",
  ...
  settings: {
    ...
    appearance: {
      ...
      background: {
        title: "Фон",
        image: "Общий фон",
        imageHint: "Выберите изображение для всего интерфейса Paseo",
        choose: "Выбрать изображение",
        change: "Изменить",
        remove: "Удалить",
        imageOpacity: "Непрозрачность изображения",
        imageOpacityHint: "Только фон, 5–50%; текст и элементы управления остаются непрозрачными",
        imageOpacityAccessibility: "Процент непрозрачности фонового изображения",
        interfaceOpacity: "Непрозрачность интерфейса",
        interfaceOpacityHint: "Текст, значки, изображения, карточки и элементы управления; 10–100%",
        interfaceOpacityAccessibility: "Процент непрозрачности интерфейса",
        dialogTitle: "Выбрать фоновое изображение",
        loadError: "Не удалось использовать изображение. Выберите другой локальный файл.",
        saveError: "Не удалось сохранить настройку фона. Повторите попытку.",
      },
      detailLevel: {
    ...
    host: {
      ...
      pairDevices: {
        ...
        rowHint: "Подключите телефон напрямую или через зашифрованный Relay.",
      },
      orchestration: {
        title: "оркестровка",
