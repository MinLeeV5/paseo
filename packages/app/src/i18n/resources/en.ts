  ...
  agentPanel: {
    ...
    goal: {
      ...
      archive: {
        action: "Archive Goal",
        title: "Archive Goal?",
        message: "This hides this Goal's status bar. The Agent and Goal are not stopped.",
        runningTitle: "Archive Goal?",
        runningMessage: "This hides this Goal's status bar. The Agent and Goal are not stopped.",
      },
    },
  },
  sessions: {
  ...
  workspace: {
    ...
    git: {
      ...
      diff: {
        ...
        committed: "Committed",
        sessionChanges: "Current session",
        sessionChangesDescription: "Choose a user prompt and review changes from that turn",
        sessionChangesUnavailable: "Update the host to use Prompt turn changes.",
        promptTurnSelector: "Prompt turn",
        noPromptTurns: "No prompts yet",
        promptWithAttachments: "Prompt with attachments",
        ...
        promptTurnHasChanges: "Has changes",
        sessionDiffMode: "Session diff mode",
        wholeFileDiff: "Whole-file diff",
        wholeFileDiffDescription: "Show each session file's complete current Git diff",
        sessionOnlyDiff: "Session-only diff",
        sessionOnlyDiffDescription: "Show only edits made since this agent session began",
        emptySessionChanges: "No changes in this session",
        emptyPromptChanges: "No changes in this prompt",
        sessionTrackingPending: "Send a prompt to start tracking turn changes.",
        sessionAgentRequired: "Focus an agent in this workspace to view its session changes.",
        branchUnknown: "Unknown",
        base: "base",
        newFile: "New",
        deletedFile: "Deleted",
        viewInSource: "View changes in source",
        ...
        changeProgress: "Change {{current}} of {{total}}",
  ...
  settings: {
    ...
    appearance: {
      ...
      background: {
        ...
        imageHint: "Choose an image shown across the Paseo interface",
        choose: "Choose image",
        change: "Change",
        remove: "Remove",
        imageOpacity: "Image opacity",
        imageOpacityHint: "Background only, 5–50%; text and controls remain fully opaque",
        imageOpacityAccessibility: "Background image opacity percentage",
        interfaceOpacity: "Interface opacity",
        interfaceOpacityHint: "Text, icons, images, cards, and controls; 10–100%",
        interfaceOpacityAccessibility: "Interface opacity percentage",
        dialogTitle: "Choose background image",
        loadError: "Unable to use this image. Choose another local image and try again.",
        saveError: "Unable to save the background setting. Try again.",
      },
      detailLevel: {
        title: "Detail level",
      },
