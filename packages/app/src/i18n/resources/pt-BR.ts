...
export const ptBR: TranslationResources = {
  ...
  agentPanel: {
    ...
    goal: {
      ...
      archive: {
        action: "Arquivar objetivo",
        title: "Arquivar objetivo?",
        message:
          "Isso oculta a barra de status do objetivo sem interromper o objetivo ou o agente.",
        runningTitle: "Arquivar objetivo?",
        runningMessage:
          "Isso oculta a barra de status do objetivo sem interromper o objetivo ou o agente.",
      },
    },
  ...
  workspace: {
    ...
    git: {
      ...
      diff: {
        ...
        view: "Visualização de diferenças",
        fileGrouping: "Agrupamento de arquivos",
        flatFileList: "Lista plana",
        groupByDirectory: "Agrupar por diretório",
        groupBySubmodule: "Agrupar por submódulo",
        rootDirectory: "Raiz",
        workspaceRoot: "Espaço de trabalho",
        switchToUnified: "Alternar para diff em linha",
        ...
        sessionChanges: "Sessão atual",
        promptTurnSelector: "Turno do prompt",
        noPromptTurns: "Nenhum prompt ainda",
        promptWithAttachments: "Prompt com anexos",
        ...
        promptTurnHasChanges: "Com alterações",
        sessionChangesDescription: "Arquivos alterados desde o início da sessão do agente",
        sessionChangesUnavailable: "Atualize o host para usar alterações por turno de prompt.",
        sessionDiffMode: "Modo de diff da sessão",
        wholeFileDiff: "Diff do arquivo inteiro",
        wholeFileDiffDescription: "Mostrar o diff Git atual completo de cada arquivo",
        sessionOnlyDiff: "Diff da sessão",
        sessionOnlyDiffDescription: "Mostrar apenas as edições feitas durante esta sessão",
        emptySessionChanges: "Nenhuma alteração nesta sessão",
        emptyPromptChanges: "Nenhuma alteração neste prompt",
        sessionTrackingPending: "O rastreamento começará no próximo turno deste agente.",
        sessionAgentRequired: "Selecione um agente neste workspace.",
        branchUnknown: "Desconhecido",
        base: "base",
        newFile: "Novo",
        deletedFile: "Excluído",
        viewInSource: "Ver alterações no código-fonte",
        ...
        changeProgress: "Alteração {{current}} de {{total}}",
        addedLine: "Linha adicionada",
        deletedLine: "Linha excluída",
  ...
  panels: {
    ...
    file: {
      ...
      editor: {
        ...
        diff: "Diff",
        source: "Fonte",
        expandFullFile: "Expandir arquivo completo",
  ...
  settings: {
    ...
    appearance: {
      ...
      background: {
        ...
        image: "Plano de fundo global",
        imageHint: "Escolha uma imagem para toda a interface do Paseo",
        choose: "Escolher imagem",
        change: "Alterar",
        remove: "Remover",
        imageOpacity: "Opacidade da imagem",
        imageOpacityHint: "Somente o fundo, 5–50%; texto e controles continuam opacos",
        imageOpacityAccessibility: "Porcentagem de opacidade da imagem de fundo",
        interfaceOpacity: "Opacidade da interface",
        interfaceOpacityHint: "Texto, ícones, imagens, cartões e controles; 10–100%",
        interfaceOpacityAccessibility: "Porcentagem de opacidade da interface",
        dialogTitle: "Escolher imagem de fundo",
        loadError: "Não foi possível usar esta imagem. Escolha outra imagem local.",
        saveError: "Não foi possível salvar a configuração do fundo. Tente novamente.",
      },
      detailLevel: {
